...
# Define the query as a string - you can use triple quotes for multi-line queries
query = '''
...
response = finite_state_sdk.send_graphql_query(token, ORGANIZATION_CONTEXT, query, variables)
