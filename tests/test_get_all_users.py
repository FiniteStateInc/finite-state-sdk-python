...
from finite_state_sdk import get_all_users, queries
...
class TestGetAllUsers:
    ...
    mock_response_data = ["user1", "user2", "user3"]

    @patch("finite_state_sdk.get_all_paginated_results", return_value=mock_response_data)
    def test_get_all_users(self, mock_get_all_paginated_results):
        # Call the function
        ...
        # Assertions
        expected_query = queries.ALL_USERS['query']
        expected_variables = queries.ALL_USERS['variables']
