...
from finite_state_sdk import create_test_as_binary_analysis, UploadMethod


class TestCreateTestAsBinaryAnalysis:
    # Define test data
    ...
    def test_create_test_as_binary_analysis(self, mock_create_test):
        mock_create_test.return_value = self.mock_response['data']

        response = create_test_as_binary_analysis(
            self.auth_token,
